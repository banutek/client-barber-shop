...
export const ShopService = {
  get_all_active_shop: () =>
    BaseMethods.getRequest(barberShopUrls.GET_ALL_ACTIVE_BARBER_SHOPS, false),
  get_barber_shop_by_id: (shopId: string) =>
    BaseMethods.getRequest(barberShopUrls.GET_BARBER_SHOP_BY_ID(shopId), false),
